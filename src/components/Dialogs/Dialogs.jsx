...
const Dialogs = (props) => {
    ...
    let dialogElements = props.dialogsData.map(dialog => (<DialogItem person_name={dialog.name} person_id={dialog.id}/>))
    let messageElements = props.messageData.map( message => (<OneMessage one_message_text={message.message}/>))
